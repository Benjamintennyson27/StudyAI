  ...
  return (
    <div className="flex h-full flex-col items-center justify-center bg-bg px-6">
      <div className="flex items-center gap-2">
        ...
        <span className="font-display text-2xl font-bold tracking-tight">study ai</span>
      </div>
      ...
      <div className="mt-10 grid w-full max-w-3xl gap-4 md:grid-cols-2">
        ...
        <ModeCard
          ...
          body="Use your OpenAI or Anthropic key for the highest-quality notes, quizzes, chat, and voices. You pay your provider directly — no StudyAI subscription, ever."
        />
      </div>
