...
const DATA_FOLDER =
  typeof navigator !== "undefined" && navigator.platform.startsWith("Win")
    ? "%APPDATA%\\StudyAI"
    : "~/Library/Application Support/StudyAI";
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[380px_1fr]">
        ...
        <div className="space-y-6">
            ...
            {prefs.mode === "cloud" ? (
              ...
              <div className="mt-5 rounded-xl border border-edge bg-panel p-4">
                ...
                <p className="mt-1 text-sm text-ink-faint">
                  ...
                  different one — your choice is remembered, so StudyAI won't ask
          ...
          <div className="rounded-card border border-edge bg-card p-6 shadow-soft">
            ...
            <p className="mt-1 text-sm text-ink-faint">
              StudyAI is free and open source (AGPL-3.0). Your notes are yours —
            ...
            <div className="mt-4 flex items-center gap-3">
              <button
                onClick={async () => {
                  ...
                  downloadText("studyai-notes.md", all, "text/markdown");
